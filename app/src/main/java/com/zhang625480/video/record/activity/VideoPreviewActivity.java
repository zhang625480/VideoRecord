...
import com.zhang625480.video.record.view.MyVideoView;
...
public class VideoPreviewActivity extends Activity implements View.OnClickListener  {
    ...
    private MyVideoView videoViewShow;
...
//                    LogUtil.e(LOG_TAG, time + "..time：" + currentTime);
    ...
    private void assignViews() {
        videoViewShow = (MyVideoView) findViewById(R.id.videoView_show);
...
//        layoutParams.width = dm.heightPixels * 3 / 4;//根据屏幕宽度设置预览控件的尺寸，为了解决预览拉伸问题
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_done:
                ...
                intent.putExtra("path",/*file.getAbsolutePath()*/path);
